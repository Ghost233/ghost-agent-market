...
4a. 包含 `reviewer_profile_preflight`（requested/effective/status/evidence）；普通 module 在设置 goal 前必须为 ready/applied 且 effective 为 sonnet/max，parallel-plan diff_self_check 例外为 not_required 并有证据。
