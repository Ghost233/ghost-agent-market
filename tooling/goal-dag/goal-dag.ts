...
function validatePlanOwnersAgainstRegistry(plan: Plan, goal: GoalContract): void {
...
function taskBinding(
  ...
  return {
    ...
    owner_scope_excludes: moduleOwner ? (subject as OwnerDefinition).excluded_paths : [],
    readable_paths: subjectScope(subject),
    readable_path_excludes: moduleOwner ? (subject as OwnerDefinition).excluded_paths : [],
    searchable_paths: subjectScope(subject),
    searchable_path_excludes: moduleOwner ? (subject as OwnerDefinition).excluded_paths : [],
