...
```text
node ${KIMI_SKILL_DIR}/../../scripts/goal-dag.mjs source-audit <plan_path> <state_path> <task_id> <reservation_token> <classification_path>
node ${KIMI_SKILL_DIR}/../../scripts/goal-dag.mjs diff-audit <plan_path> <state_path> <task_id> <reservation_token>
node ${KIMI_SKILL_DIR}/../../scripts/goal-dag.mjs commit-readiness <plan_path> <state_path> <task_id> <reservation_token>
```
...
```text
node ${KIMI_SKILL_DIR}/../../scripts/goal-dag.mjs checkpoint <plan_path> <state_path> <task_id> <reservation_token> <checkpoint_path>
```
