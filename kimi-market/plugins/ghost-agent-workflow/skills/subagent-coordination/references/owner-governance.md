...
```text
node ${KIMI_SKILL_DIR}/../../scripts/owner-registry.mjs init <workspace>
node ${KIMI_SKILL_DIR}/../../scripts/owner-registry.mjs validate <registry.json>
node ${KIMI_SKILL_DIR}/../../scripts/owner-registry.mjs route <registry.json> <repo-relative-path>
node ${KIMI_SKILL_DIR}/../../scripts/owner-registry.mjs validate-change <registry.json> <request.json> <validation.json>
node ${KIMI_SKILL_DIR}/../../scripts/owner-registry.mjs apply-change <registry.json> <request.json> <validation.json> <approval.json>
```
...
```text
node ${KIMI_SKILL_DIR}/../../scripts/goal-dag.mjs owner-lease-inspect <workspace> <owner_id>
node ${KIMI_SKILL_DIR}/../../scripts/goal-dag.mjs owner-lease-heartbeat <workspace> <owner_id> <reservation_token>
node ${KIMI_SKILL_DIR}/../../scripts/goal-dag.mjs owner-lease-recover <workspace> <owner_id> <reservation_token> <reason>
```
...
```text
node ${KIMI_SKILL_DIR}/../../scripts/goal-dag.mjs expand-task-scope <plan> <state> <task_id> <token> <exact_repo_path>...
```
